        ...
        void Start()
        {
            ...
            if (PlayerManager.LocalPlayerInstance == null)
            {
                if (PhotonNetwork.IsMasterClient) // 2
                {
                    ...
                    // 3
                    player1 = PhotonNetwork.Instantiate("FG3D_DH_Ethnic_European_East", player1SpawnPosition.transform.position, player1SpawnPosition.transform.rotation, 0);
                    // 4
                ...
                {
                    player2 = PhotonNetwork.Instantiate("FG3D_DH_Ethnic_European_East", player2SpawnPosition.transform.position, player2SpawnPosition.transform.rotation, 0);
                }
            }
        }
